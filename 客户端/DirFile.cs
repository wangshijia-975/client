...
namespace 客户端
{
    ...
    public static class DirFile
    {
        ...
        public static void DelectDir(string directoryPath)
        {
            try
            {
        ...
        /// <returns>排序后第一个文件夹</returns>
        public static string SortAsFileName(ref DirectoryInfo[] arrFi)
        {
            Array.Sort(arrFi, (x, y) => y.CreationTime.CompareTo(x.CreationTime));
            return arrFi[0].ToString();
        }
